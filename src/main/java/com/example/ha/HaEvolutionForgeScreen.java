...
public final class HaEvolutionForgeScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredText(matrices, this.textRenderer, new LiteralText("Open forge pages to scan recipe ranges."), this.width / 2, 120, 0xA0A0A0);
        drawCenteredText(matrices, this.textRenderer, new LiteralText("Hover normal item tooltips to learn provisional stat bounds."), this.width / 2, 132, 0xA0A0A0);
